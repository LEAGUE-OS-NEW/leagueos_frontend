...
function ClubLogoCropModal({
  ...
  return (
    <div className="clcm-overlay" role="dialog" aria-modal="true" aria-label="Crop club logo">
      <div className="clcm-modal">
        <div className="clcm-header">
          <h3>Crop Club Logo</h3>
          <button type="button" className="clcm-close" onClick={onCancel} aria-label="Close">
            <FiX />
          </button>
        </div>

        <div
          className="clcm-frame"
        ...
        >
          ...
          />
          <div className="clcm-frame-ring" aria-hidden="true" />
        </div>

        <p className="clcm-ratio">1:1 Square</p>

        <label className="clcm-zoom">
          Zoom
          <input
            type="range"
            min={MIN_ZOOM}
        ...
        <div className="clcm-footer">
          <button type="button" className="ca-btn ca-btn-secondary" onClick={onCancel}>
            Cancel
          </button>
          <button type="button" className="ca-btn ca-btn-primary" onClick={handleApply} disabled={isSaving || !naturalSize}>
...
export default ClubLogoCropModal;
